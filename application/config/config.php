...
|
*/
$config['base_url'] = (@$_SERVER['HTTPS'] == 'on' ? 'https' : 'http').'://'.@$_SERVER['HTTP_HOST'];
...
$config['csrf_token_name'] = 'csrf_t_pengiriman_barang';
$config['csrf_cookie_name'] = 'csrf_c_pengiriman_barang';
