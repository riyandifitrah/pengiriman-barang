...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?= base_url('public/assets/dist/css/adminlte.min.css') ?>">
  <link rel="stylesheet" href="<?= base_url('public/assets/dist/css/my_style.css') ?>">
  <!-- Font Awesome Icons -->
  <link rel="stylesheet" href="<?= base_url('public/assets/plugins/fontawesome-free/css/all.min.css') ?>">
  ...
  <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/4.3.6/css/bootstrap.min.css">
  ...
  <script src="<?= base_url('public/assets/plugins/fontawesome/js/all.js') ?>"></script>
